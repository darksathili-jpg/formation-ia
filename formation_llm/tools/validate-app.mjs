...
const must=['Tableau de bord','Parcours 0 → 7','Laboratoires','Progression','Mode stagiaire','Mode formateur','modules/domaine-a.html','modules/domaine-b.html','modules/domaine-c.html','Module d’entrée actif','Tokenizer Lab','Attention Lab','RAG Lab','localStorage'];
