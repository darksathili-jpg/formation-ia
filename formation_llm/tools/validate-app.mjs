...
const must=['formation-llm-role','Mode formateur actif','Tableau de bord','Parcours 0 → 7','Laboratoires','Progression','Profil : stagiaire','Activer mode formateur','modules/domaine-a.html','modules/domaine-b.html','modules/domaine-c.html','Pilote V2 · retest élèves requis','Tokenizer Lab','Attention Lab','RAG Lab','localStorage'];
