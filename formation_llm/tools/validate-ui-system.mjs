...
const pages=[
 ...
 'modules/hallucination-lab.html','modules/rag-lab.html','modules/dialoguer-specifier.html','modules/dialoguer-exemples.html','modules/dialoguer-iterer.html','modules/dialoguer-multitour.html','modules/dialoguer-tache-complexe.html'
];
const errors=[];
